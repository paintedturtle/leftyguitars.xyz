...
git:
	...
	git remote add leftyguitars.xyz core@paintedturtle.xyz:spaces/paintedturtle.xyz.git
	git remote add paintedturtle.github.io git@github.com:paintedturtle/leftyguitars.git
