...
(function() {
  var Cryptography, Immutable, JSONfromHTTPRequest, Kijiji, Scripts, addInstrument, compile, echo, exec, files, identifyInstrumentAddress, indexHTML, initialize, instruments, memorize, mime, parallel, read, readFileSync, send, sendBinary, sendScript, service, sources, watch, write;
  ...
  indexHTML = function(callback) {
    return callback(void 0, "<!DOCTYPE HTML>\n<meta charset=\"UTF-8\">\n<title>Lefty Guitars For Sale Under $1000</title>\n<script charset=\"UTF-8\">" + Scripts.d3 + "</script>\n<script charset=\"UTF-8\">" + Scripts.facts + "</script>\n<script charset=\"UTF-8\">" + (compile(readFileSync("Number.coffee", "UTF-8"))) + "</script>\n<script charset=\"UTF-8\">" + (compile(readFileSync("document.coffee", "UTF-8"))) + "</script>\n<script charset=\"UTF-8\">" + (compile(readFileSync("index.coffee", "UTF-8"))) + "</script>");
  };
